...
<body>
    ...
    <!--header -->
    <h1 class=" text-white text-7xl font-bold text-center font-serif -top-0  flex-grow  group-hover:w-full pb-10 relative ">I Z I N</h1>
    ...
    <div class="flex items-center justify-center h-full  z-10 relative  ">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            <div class="flex items-center justify-center mr-5">
                ...
                <!-- Form Section -->
                <form action="{{ route('siswa.store.izin') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    @csrf
